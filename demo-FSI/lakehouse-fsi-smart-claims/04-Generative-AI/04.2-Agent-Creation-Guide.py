...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=lakehouse&notebook=04.2-Agent-Creation-Creation&demo_name=lakehouse-fsi-smart-claims&event=VIEW">
