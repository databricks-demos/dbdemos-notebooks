...
#Note: we do not recommend to change the catalog here as it won't impact all the demo resources such as (Lakeflow) Declarative Pipelines pipeline and Dashboards.
