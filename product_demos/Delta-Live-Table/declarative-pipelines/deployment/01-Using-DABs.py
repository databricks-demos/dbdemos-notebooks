...
# MAGIC * **Data pipelines**: You can also include data pipelines in CI/CD automation, using Lakeflow Pipelines, the framework in Databricks for declaring data pipelines.
...
# MAGIC %md
# MAGIC # Using Databricks Asset Bundles with Lakeflow Pipelines
