...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=governance&notebook=Azure-Securing-data-on-external-locations&demo_name=uc-02-external-location&event=VIEW">
