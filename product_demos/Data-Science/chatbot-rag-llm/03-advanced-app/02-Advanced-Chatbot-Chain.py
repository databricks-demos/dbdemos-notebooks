...
# MAGIC %pip install --quiet -U databricks-sdk==0.40.0 databricks-agents mlflow[databricks] databricks-langchain>=0.4.0 langchain==0.3.19 langchain_core==0.3.37 databricks-vectorsearch==0.49 pydantic==2.10.1
