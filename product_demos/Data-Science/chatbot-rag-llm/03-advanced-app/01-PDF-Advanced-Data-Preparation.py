...
# MAGIC %pip install --quiet -U transformers==4.30.2 pypdf==4.1.0 langchain-text-splitters==0.2.0 databricks-vectorsearch==0.44 mlflow[databricks]==2.20.1 tiktoken==0.7.0 torch==2.3.0 llama-index==0.10.43 markdownify==0.14.1
