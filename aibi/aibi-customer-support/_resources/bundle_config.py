...

{
    ...
    "sql_queries": [
      ...
      [
        ...
        "INSERT OVERWRITE TABLE `{{CATALOG}}`.`{{SCHEMA}}`.agents_clean SELECT ticket_id, agent_group, agent_name, try_cast(agent_interactions AS DOUBLE) AS agent_interactions FROM `{{CATALOG}}`.`{{SCHEMA}}`.agents_bronze;",
