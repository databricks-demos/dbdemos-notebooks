...
# MAGIC
# MAGIC Lakeflow Pipelines makes it easy to track your data quality and set alerts when something is wrong! Open the [/1-sdp-sql/explorations/02-Pipeline-event-monitoring]($./1-sdp-sql/explorations/02-Pipeline-event-monitoring) notebook for more details.