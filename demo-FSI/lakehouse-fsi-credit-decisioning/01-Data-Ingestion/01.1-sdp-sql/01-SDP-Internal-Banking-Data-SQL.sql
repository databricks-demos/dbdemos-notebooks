...
-- MAGIC %md
-- MAGIC ## Building a Lakeflow pipeline to analyze consumer credit
-- MAGIC
...
-- MAGIC %md
-- MAGIC Your Lakeflow pipeline has been installed and started for you! Open the <a dbdemos-pipeline-id="sdp-fsi-credit-decisioning" href="#joblist/pipelines" target="_blank">Lakeflow pipeline</a> to see it in action.<br/>
