...
# MAGIC %pip install mlflow==2.11.3 importlib-metadata==6.8.0 cloudpickle==2.2.1 zipp==3.16.2
...
# MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&cid=555&aip=1&t=event&ec=field_demos&ea=display&dp=%2F42_field_demos%2Fmanufacturing%2Flakehouse_iot_turbine%2Fdlt_sql_udf&dt=LAKEHOUSE_MANUFACTURING_TURBINE">
