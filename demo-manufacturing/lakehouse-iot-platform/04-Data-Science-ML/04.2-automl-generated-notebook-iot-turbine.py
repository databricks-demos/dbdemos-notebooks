...
# MAGIC %uv pip install mlflow==3.14.0 cloudpickle databricks-sdk lightgbm scikit-learn==1.9.0 shap==0.52.0
...
# MAGIC %md 
# MAGIC ### The model generated by AutoML is ready to be used in our Lakeflow pipeline to detect Wind Turbine requiring potential maintenance.
# MAGIC
# MAGIC Our Data Engineer can now easily retrive the model `dbdemos_turbine_maintenance` from our Auto ML run and detect anomalies within our Lakeflow Pipelines.<br>
...
# MAGIC
# MAGIC The pipeline created with the Databricks Platform will offer a strong ROI: in the few hours that it took to set this pipeline up we are effectively saving our organization MILLIONS of dollars by month!
# MAGIC
