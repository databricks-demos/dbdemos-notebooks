...

{
  ...
  "cluster": {}, 
  "pipelines": [],
  "dashboards": [{"name": "[dbdemos] AI/BI - Portfolio Assistant",       "id": "portfolio-assistant"}
                ],
  "data_folders":[
    {"source_folder":"aibi/dbdemos_aibi_fsi_portfolio_assistant/news",              "source_format": "parquet", "target_table_name":"news",              "target_format":"delta"},
    {"source_folder":"aibi/dbdemos_aibi_fsi_portfolio_assistant/prices",               "source_format": "parquet", "target_table_name":"prices",               "target_format":"delta"},
    {"source_folder":"aibi/dbdemos_aibi_fsi_portfolio_assistant/portfolio",                 "source_format": "parquet", "target_table_name":"portfolio",                 "target_format":"delta"},
    {"source_folder":"aibi/dbdemos_aibi_fsi_portfolio_assistant/fundamentals",              "source_format": "parquet", "target_table_name":"fundamentals",              "target_format":"delta"},
    {"source_folder":"aibi/dbdemos_aibi_fsi_portfolio_assistant/news_ticker",                 "source_format": "parquet", "target_table_name":"news_ticker",                 "target_format":"delta"}, ],
  "genie_rooms":[
    {"display_name": "DBDemos - AI/BI - Portfolio Assistant",
     "id": "portfolio-assistant-genie",
     "description": "Easily analyze your portfolio performance and market trends using the GenAI Assistant. Dive into your data and key financial metrics, and ask plain-language questions through Genie to make smarter, data-driven investment decisions.",
     "table_identifiers": ["{{CATALOG}}.{{SCHEMA}}.news",
                           "{{CATALOG}}.{{SCHEMA}}.prices",
                           "{{CATALOG}}.{{SCHEMA}}.portfolio",
                           "{{CATALOG}}.{{SCHEMA}}.fundamentals",
                           "{{CATALOG}}.{{SCHEMA}}.news_ticker"],
     "sql_instructions": [{"title": "Compute volatility for a given ticker", "content": "SELECT TICKER, STDDEV('return') AS volatility FROM prices GROUP BY TICKER"}],
