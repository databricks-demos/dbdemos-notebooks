...
# MAGIC %md ## Exploring REST API Using Databricks' OSS Delta Sharing Server
# MAGIC
# MAGIC Databricks hosts a sharing server for test: https://sharing.delta.io/ 
# MAGIC
# MAGIC *Note: it doesn't require authentication, real-world scenarios require a Bearer token in your calls*
...
# MAGIC Delta Share works by creating temporary self-signed links to download the underlying files. It leverages Delta Lake statistics to push down the query and only retrieve a subset of files. 
# MAGIC
# MAGIC The REST API allows you to get those links and download the data:
