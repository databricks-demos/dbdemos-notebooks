...
-- MAGIC %md-sandbox
-- MAGIC ## Ask plain System Table Dashboard - Leverage AI with Lakehouse
-- MAGIC
...
-- MAGIC
-- MAGIC The Genie space is ready with some example / instructions to improve your Q&A experience! Feel free to open an issue in our [dbdemos git repository](https://github.com/databricks-demos/dbdemos) if you can't find the answer you're looking for, we'll improve it over time!
-- MAGIC
