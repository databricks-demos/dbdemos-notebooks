...
-- MAGIC %md
-- MAGIC Open the [01.1-sdp-sql/transformations/02-silver.sql]($./01.1-sdp-sql/transformations/02-silver.sql) file to review the SQL code creating our clean silver table.
...
-- MAGIC %md
-- MAGIC Open the [01.1-sdp-sql/transformations/03-gold.sql]($./01.1-sdp-sql/transformations/03-gold.sql) file to review the SQL code creating our enriched gold table.
