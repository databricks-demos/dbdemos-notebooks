...
# MAGIC
# MAGIC As you'll see, this implementation is lower level than a Lakeflow pipeline, and you'll have control over all the implementation details (handling checkpoints, data quality etc).
# MAGIC
