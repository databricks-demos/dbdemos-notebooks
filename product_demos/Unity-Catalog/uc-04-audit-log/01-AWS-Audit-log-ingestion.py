...
# MAGIC
# MAGIC Note that we could also use a small Lakeflow pipeline to do that, this would prevent us from having to deal with checkpoints and autoloader restart.
