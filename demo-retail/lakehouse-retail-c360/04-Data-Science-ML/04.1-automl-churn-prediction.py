...
# MAGIC
# MAGIC The users table enriched with churn data has been saved within our Lakeflow pipeline. All we have to do is read this information, analyze it and start an Auto-ML run.
# MAGIC
...
# MAGIC %md 
# MAGIC ### The model generated by AutoML is ready to be used in our Lakeflow pipeline to detect customers about to churn.
# MAGIC
# MAGIC Our Data Engineer can now easily retrieve the model `dbdemos_customer_churn` from our Auto ML run and predict churn within our Lakeflow pipeline.<br>
