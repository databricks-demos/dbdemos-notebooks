...
# MAGIC %pip install -U transformers==4.41.1 pypdf==4.1.0 langchain-text-splitters==0.2.0 databricks-vectorsearch mlflow==2.20.0 tiktoken==0.7.0 torch==2.3.0 llama-index==0.10.43
