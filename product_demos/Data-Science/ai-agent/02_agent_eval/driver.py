...
predict_wrapper("{'request': 'What color options are available for the Aria Modern Bookshelf?'}")
...
with mlflow.start_run():
    results = mlflow.genai.evaluate(
        data=eval_data,
        predict_fn=predict_wrapper,  # Replace with your actual function
        scorers=scorers,
        # Optional: Add model parameters if you want to log them
