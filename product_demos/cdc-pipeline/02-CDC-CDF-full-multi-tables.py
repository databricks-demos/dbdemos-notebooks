...
# MAGIC
# MAGIC **A note on Lakeflow Pipelines**:<br/>
# MAGIC *Lakeflow Pipelines has been designed to simplify this process and handle concurrent execution properly, without having you to start multiple streams in parallel.*<br/>
# MAGIC *We strongly advise to have a look at the Lakeflow Pipelines CDC demo to simplify such pipeline implementation: `dbdemos.install('dlt-cdc')`*
# MAGIC
# MAGIC In this notebook, we'll see how this can be done using Python & standard streaming APIs (without Lakeflow Pipelines).
# MAGIC
...
# MAGIC To simplify these operations & error handling, we strongly advise you to run your CDC pipelines on top of Lakeflow Pipelines: `dbdemos.install('pipeline-bike')`
