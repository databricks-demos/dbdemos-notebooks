...
# MAGIC
# MAGIC - At scale, a cluster (in batch or streaming, including within Lakeflow Pipelines)
...
# MAGIC %pip install databricks-sdk mlflow==3.14.0 torch torchvision "huggingface-hub==0.36.2"
