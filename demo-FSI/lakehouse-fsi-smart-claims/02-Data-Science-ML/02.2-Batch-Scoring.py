...
# MAGIC
# MAGIC *Note: we could also have these transformations available in a Lakeflow pipeline. Open [02.2-EXTRA-Batch-Scoring-DLT]($./EXTRA-SDP-inference/02.2-EXTRA-Batch-Scoring-SDP) to see how it's done.*
# MAGIC
# MAGIC
...
# MAGIC %pip install mlflow==3.14.0 "huggingface-hub==0.36.2"
