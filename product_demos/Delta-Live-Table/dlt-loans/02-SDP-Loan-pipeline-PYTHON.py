...
# MAGIC %md-sandbox
# MAGIC # Simple ETL with Lakeflow Pipelines
# MAGIC
# MAGIC Lakeflow Pipelines makes Data Engineering accessible for all. Just declare your transformations in SQL or Python, and Lakeflow Pipelines will handle the Data Engineering complexity for you.
# MAGIC
...
# MAGIC
# MAGIC **Your Lakeflow pipeline is ready!** Your pipeline was started using the SQL notebook and is <a dbdemos-pipeline-id="sdp-loans" href="/#joblist/pipelines/460f840c-9ecc-4d19-a661-f60fd3a88297">available here</a>.
# MAGIC
...
# MAGIC
# MAGIC Note that we don't have to worry about compactions, Lakeflow Pipelines handles that for us.
# MAGIC
# MAGIC #### Expectations
...
# MAGIC
# MAGIC Because these tables will be requested at scale using a SQL Endpoint, we'll add Liquid Clustering at the table level to organize data for faster queries, and Lakeflow Pipelines will handle the rest.
...
# MAGIC %md ## Next steps
# MAGIC
# MAGIC Your Lakeflow pipeline is ready to be started. <a dbdemos-pipeline-id="sdp-loans" href="/#joblist/pipelines/460f840c-9ecc-4d19-a661-f60fd3a88297">Click here to access the pipeline</a> created for you using the SQL notebook.
# MAGIC
# MAGIC To create a new one using this notebook, open the Lakeflow Pipelines menu, create a pipeline and select this notebook to run it. To generate sample data, please run the [companion notebook]($./_resources/00-Loan-Data-Generator) (make sure the path where you read and write the data are the same!)
# MAGIC
...
# MAGIC
# MAGIC
# MAGIC See [how to access your Lakeflow Pipelines metrics]($./03-Log-Analysis)
# MAGIC
