...
# MAGIC %sql
# MAGIC SELECT * FROM system.information_schema.catalogs where catalog_name='databricks_bge_m3_model'

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT * FROM system.information_schema.tables where table_catalog='forrester_demo' and table_schema != 'information_schema'
