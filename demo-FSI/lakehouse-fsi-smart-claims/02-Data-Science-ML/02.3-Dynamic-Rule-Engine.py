...
# MAGIC
# MAGIC Many system exists to build such rules. These can be natively implemented in Spark or using Spark Declarative Pipelines (check `dbdemos.install('sdp-unit-test')` for an example of dynamic SDP rules)
# MAGIC
