...
# MAGIC
# MAGIC In this notebook, we'll show you an alternative to Lakeflow Pipelines: building an ingestion pipeline with the Spark API.
# MAGIC
# MAGIC As you'll see, this implementation is lower level than the Lakeflow Pipelines, and you'll have control over all the implementation details (handling checkpoints, data quality etc).
# MAGIC
...
# MAGIC
# MAGIC If you're unsure what to use, start with Lakeflow Pipelines!
# MAGIC
# MAGIC *Remember that Lakeflow Jobs can be used to orchestrate a mix of Lakeflow Pipelines with standard Spark pipeline.*
# MAGIC
# MAGIC ### Dataset:
# MAGIC
...
# MAGIC %uv pip install mlflow==2.22.0
...
# MAGIC
# MAGIC
# MAGIC #### To solve these challenges, Databricks introduced **Lakeflow Pipelines**
