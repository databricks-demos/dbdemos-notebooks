...
-- MAGIC %md
-- MAGIC # 4/ End to End Lakeflow Production Pipeline for product review and classification with SQL AI QUERY
-- MAGIC
-- MAGIC
-- MAGIC In this demo, we will create a production ready pipeline for the product review and classification using Lakeflow Pipelines framework
-- MAGIC
