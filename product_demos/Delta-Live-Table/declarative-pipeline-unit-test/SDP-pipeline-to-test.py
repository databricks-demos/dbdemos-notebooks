...
# MAGIC %md 
# MAGIC # Lakeflow Pipelines - Unit testing
# MAGIC
# MAGIC ## Why testing?
# MAGIC
# MAGIC Deploying tests on your Lakeflow pipelines will guarantee that your ingestion is always stable and future proof.
# MAGIC
...
# MAGIC
# MAGIC ## Unit testing strategy with Lakeflow Pipelines
# MAGIC
# MAGIC Lakeflow Pipelines logic can be unit tested leveraging Expectation.
# MAGIC
# MAGIC At a high level, the Lakeflow pipelines can be constructed as following:
# MAGIC
...
# MAGIC * A common Lakeflow pipeline logic is used for both the prod and the test pipeline (the **yellow** in the graph)
...
# MAGIC
# MAGIC Your pipeline has been created! You can directly access the <a dbdemos-pipeline-id="sdp-test" href="#joblist/pipelines/cade4f82-4003-457c-9f7c-a8e5559873b6">Lakeflow Pipelines for unit-test demo</a>.
# MAGIC
...
# MAGIC
# MAGIC
# MAGIC *Note: Lakeflow Pipelines is available as SQL or Python, this example will use Python*
...
# MAGIC %md
# MAGIC # Going further with Lakeflow Pipelines

# COMMAND ----------

# MAGIC %md
# MAGIC ## Checking your data quality metrics with Lakeflow Pipelines
# MAGIC Lakeflow Pipelines tracks all your data quality metrics. You can leverage the expecations directly as SQL table with Databricks SQL to track your expectation metrics and send alerts as required. This let you build the following dashboards:
# MAGIC
