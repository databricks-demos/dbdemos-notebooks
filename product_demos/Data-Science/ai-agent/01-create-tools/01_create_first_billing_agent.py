...
# MAGIC %uv pip install mlflow>=3.10.1 databricks-langchain databricks-agents unitycatalog-langchain[databricks] databricks-feature-engineering==0.14.0 "typing_extensions>=4.13"
