...
# MAGIC
# MAGIC *Note that this demo leverages the standard spark API. You could also implement this same pipeline in pure SQL leveraging Lakeflow Pipelines. For more details on Lakeflow Pipelines, install `dbdemos.install('pipeline-bike')`*
# MAGIC
