...
# MAGIC
# MAGIC *Note: we could also have these transformations available in a Lakeflow pipeline. Open [02.2-EXTRA-Batch-Scoring-DLT]($./EXTRA-DLT-inference/02.2-EXTRA-Batch-Scoring-DLT) to see how it's done.*
# MAGIC
# MAGIC
