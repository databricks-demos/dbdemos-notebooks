...
# MAGIC
# MAGIC [Go back to the introduction]($../00-Credit-Decisioning) or discover how to use Lakeflow Jobs to orchestrate everything together through the [06-Workflow-Orchestration-credit-decisioning]($../06-Workflow-Orchestration/06-Workflow-Orchestration-credit-decisioning).
